...
typedef enum { MILENA_FN_NUMBER, MILENA_FN_PARAMETER, MILENA_FN_ADD, MILENA_FN_SUB,
               MILENA_FN_MUL, MILENA_FN_DIV, MILENA_FN_CALL, MILENA_FN_RETURN } MilenaFunctionNodeType;
typedef struct MilenaFunctionNode {
    MilenaFunctionNodeType type;
    double number;
    size_t index;
    char *name;
    struct MilenaFunctionNode **children;
    size_t child_count;
} MilenaFunctionNode;

typedef struct MilenaFunctionParameter { char *name; } MilenaFunctionParameter;
struct MilenaFunction { char *name; MilenaFunctionParameter *parameters; size_t parameter_count;
                         MilenaFunctionNode *body; };
...
bool milena_function_call(const MilenaFunctionTable *table, const char *name,
                          const double *arguments, size_t argument_count,
